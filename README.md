...
| 3 | [Brute Force Detection](./labs/Lab3-Brute-Force-Detection.md) | T1110.001 | 10 failed attempts in 5 sec from localhost via svchost | ✅ |
...
| 5 | [RDP Auth & Explicit Credential Detection](./labs/Lab5-RDP-Lateral-Movement.md) | T1021.001, T1078 (partial) | EventCode 4648 — explicit credential use via cmdkey observed on local host | ✅ |
...
> **Note on T1055 (Lab 2):** RuntimeBroker.exe → PowerShell is an anomalous parent-child relationship. T1055 is assessed as suspected. Confirmation requires Sysmon Event ID 8 (CreateRemoteThread) or Event ID 10 (ProcessAccess) evidence.
